              ...
              <div v-for="(jugador,index) in jugadoresTeam1" :key="index">
                <el-row justify="end">
                  ...
                  <img  :src="jugador.imgrank" width="23" height="23">
                    <el-input :v-show="jugador.rank" style="max-width: 100px" class="w-30 m-2" type="text" id="name" name="name" v-model="name" :placeholder="jugador.rank" disabled width="30">\
                    </el-input>
                  </el-col>
                </el-row>
              </div>
